    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="watch_videos.php" class="list-group-item list-group-item-action "><span></span> Watch Videos</a>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col text-center">
                                        <a href="watch_videos.php"><img src="icon/youtube.png" width="57px" />
                                            <p>Watch Videos</p>
                                        </a>
                                    </div>
                                </div>
